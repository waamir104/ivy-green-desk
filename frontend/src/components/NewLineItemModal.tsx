...
export const NewLineItemModal: React.FC<NewLineItemModalProps> = ({ isOpen, onClose }) => {
        ...
        >
          <div className="modal__container large">
            <div className="header-modal">
              <h3 className="header-modal__label">New Item</h3>
              <button
                type="button"
                ...
                <div className="col" ref={tax1Ref}>
                  ...
                  <div className={`v2-dropup v2-dropdown${openDropdown === "tax1" ? " is-open" : ""}`}>
                    <button
                      ...
                      onClick={() => setOpenDropdown((k) => (k === "tax1" ? null : "tax1"))}
                    >
                    ...
                    <div className="v2-dropdown__menu content-full scrolls">
                      <ul>
                        {TAX_OPTIONS.map((opt) => (
                          <li
                            key={opt || "none"}
                            className={`items${tax1 === opt ? " active" : ""}`}
                            title={opt || ""}
                            onClick={() => {
                              setTax1(opt);
                              setOpenDropdown(null);
                ...
                <div className="col" ref={tax2Ref}>
                  ...
                  <div className={`v2-dropup v2-dropdown${openDropdown === "tax2" ? " is-open" : ""}`}>
                    <button
                      type="button"
                      className="dropbtn items"
                      onClick={() => setOpenDropdown((k) => (k === "tax2" ? null : "tax2"))}
                    >
                    ...
                    <div className="v2-dropdown__menu content-full scrolls">
                      <ul>
                        {TAX_OPTIONS.map((opt) => (
                          <li
                            key={opt || "none"}
                            className={`items${tax2 === opt ? " active" : ""}`}
                            title={opt || ""}
                            onClick={() => {
                              setTax2(opt);
                              setOpenDropdown(null);
            ...
            <div className="footer-modal btn-close">
              <button type="button" className="v2-btn-default --transparent ml-n2" onClick={onClose}>
                Cancel
              </button>
